...
export default function KpiCard({ icon, label, value, delta, deltaTone, hint, iconBg, iconColor }: KpiCardProps) {
  return (
    <div className="bg-white dark:bg-dark-surface-container p-5 rounded-xl border border-slate-100 dark:border-dark-outline-variant shadow-[2px_2px_8px_rgba(42,99,138,0.05)] hover:border-primary/20 transition-all"> <div className="flex items-start justify-between mb-3"> <span className="p-2 rounded-lg flex items-center justify-center"
          style={{
